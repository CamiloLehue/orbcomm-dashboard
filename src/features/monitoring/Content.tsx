...
function Content({ origen, destino, origenDestinyAsigned = [[-43.1375, -73.6425], [-42.1350, -73.6400]]
}: contentProps) {
                            ...
                            gridMap && (
                                <div className="absolute flex flex-col left-0 top-9 w-[400px] h-[400px] bg-bgt shadow-xl shadow-zinc-950/50 rounded-lg z-[9999]">
                                    ...
                                    <div className="grid grid-cols-2 grid-rows-2 gap-2 w-full h-full p-5">
                                        <div onClick={() => { setGridType("grid grid-cols-1") }} className="flex justify-center items-center bg-bgp hover:bg-gray transition-all duration-150 rounded-2xl p-3">
                                            <div className="relative bg-gray/60 w-full h-full rounded-xl">
                                            </div>
                                        </div>
                                        <div onClick={() => { setGridType("grid grid-cols-2 grid-rows-2") }} className="bg-bgp hover:bg-gray transition-all duration-150 rounded-2xl grid grid-cols-2 grid-rows-2 p-3 gap-1">
                                            <div className="relative bg-gray/60 w-full h-full rounded-lg">
                                            </div>
                                            <div className="relative bg-gray/60 w-full h-full rounded-lg">
                                            </div>
                                            <div className="relative bg-gray/60 w-full h-full rounded-lg">
                                        ...
                                        <div onClick={() => { setGridType("grid grid-cols-3 grid-rows-2") }} className="bg-bgp hover:bg-gray transition-all duration-150 rounded-2xl grid grid-cols-2 grid-rows-3 p-3 gap-1">
                                            <div className="relative bg-gray/60 w-full h-full rounded">
                                            </div>
                                            <div className="relative bg-gray/60 w-full h-full rounded">
                                            </div>
                                            <div className="relative bg-gray/60 w-full h-full rounded">
                                        ...
                                        <div onClick={() => { setGridType("grid grid-cols-4 grid-rows-2") }} className="bg-bgp hover:bg-gray transition-all duration-150 rounded-2xl grid grid-cols-2 grid-rows-4 p-3 gap-1">
                                            <div className="relative bg-gray/60 w-full h-full rounded">
                                            </div>
                                            <div className="relative bg-gray/60 w-full h-full rounded">
                                            </div>
                ...
                <div className={`col-span-3 ${gridType}`}>
                    {
                        ...
                        <MapView
                            ...
                            origenDestinyAsigned={origenDestinyAsigned}
                        />
