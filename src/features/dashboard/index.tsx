...
function Dashboard() {
  ...
  const [verArticle, setVerArticle] = useState(false)
        ...
        <article className="relative shadow-xl shadow-bgp bg-gradient-to-b from-primary/90 to-primary/40 col-span-3 flex flex-col gap-2 rounded-2xl">
          {
            verArticle ?
              ...
              :
              <div className="flex bg-bgp/90 flex-col justify-center items-center h-full w-full text-white ">
                <div className="h-10 w-10 border border-white border-b-transparent animate-spin rounded-full">
                </div>
                <h2>Conectando</h2>
