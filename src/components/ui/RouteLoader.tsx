...
function RouteLoader() {
    ...
    return (
        <div className="absolute z-[9999] top-0 left-0 w-full h-full bg-bgp bg-opacity-50 flex flex-col justify-center items-center gap-5">
            <div className='flex flex-col justify-center items-center w-full h-full bg-gradient-to-tl from-red-500/20'>
                <div className="relative flex flex-col  justify-center">
                    <div className='flex flex-col justify-center items-center gap-2 w-full'>
                        <h1 className='font-bold text-5xl'>W I S E N S O R</h1>
                    </div>
                    <div
                        className="absolute top-0 left-0 h-full  bg-gradient-to-bl from-red-600 to-red-500 mix-blend-multiply"
