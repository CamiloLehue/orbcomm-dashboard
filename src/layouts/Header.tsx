...
function Header() {
    ...
    return (
        <header className="sticky top-0 z-[9999] flex items-center justify-between w-full mx-auto  pb-3 mb-3  px-4">
            ...
            <div className="flex justify-center items-center gap-10 bg-gray/20 border border-gray/20 rounded-s-full px-1">
                ...
                <Button onClick={() => { setOpenNotification(!openNotification); setOpenConfiguration(false); setOpenProfile(false) }} rounded="full"
                    ...
                    {
                        openNotification && (
                            <Dropdown onClickVoid={openNotification}>
                ...
                <Button
                    onClick={() => { setOpenConfiguration(!openConfiguration); setOpenNotification(false); setOpenProfile(false) }}
                    rounded="full"
                ...
                >
                    ...
                    {
                        openConfiguration && (
                            <Dropdown onClickVoid={openConfiguration}>
                                <div className="bg-gray/20 border-b border-gray/40 shadow-lg shadow-bgb backdrop-blur-xl rounded-b-xl">
                ...
                <Button onClick={() => { setOpenProfile(!openProfile); setOpenConfiguration(false); setOpenNotification(false); }}
                    ...
                    {
                        openProfile && (
                            <Dropdown onClickVoid={openProfile}>
